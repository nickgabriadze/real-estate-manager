...
export default function setupFormData(listingForm: ListingForm){
    ...
    formData.append('region_id', String(listingForm.region[0]))
    formData.append('city_id', String(listingForm.city[0]))
    ...
    formData.append('agent_id', String(listingForm.agent_id[0]))
