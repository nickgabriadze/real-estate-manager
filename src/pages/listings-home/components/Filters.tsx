...
import {removeRegionFilters, resetAll} from "../../../features/filters/filterReducer.ts";
    ...
    return <section className={filterStyles['filterWrapper']}>
        <div className={filterStyles['filtersCreate']}>
            <div className={filterStyles['filterOptions']}>
                <RegionFilter regionsData={data?.data ? data.data : []} isLoading={isLoading}
        ...
        <div className={filterStyles['selectedFilters']}>
            ...
            {filtersAvailable && <button onClick={() => filterDispatch(resetAll({}))}>გასუფთავება</button>}
        </div>
    </section>
}